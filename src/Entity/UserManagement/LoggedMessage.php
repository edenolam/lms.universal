 ...
 *
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="App\Repository\UserManagement\LoggedMessageRepository")
 * @ORM\Table(name="swift_message_logs")
 */
class LoggedMessage
{
    /**
    ...
    {
        $date = new DateTime();
        $this->setDate($date->setTimestamp($message->getDate()->getTimestamp()));
